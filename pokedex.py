...
class datosGUI():
    ...
    def __init__(self,nombre,pokePoder,pokeNombre,pokeAtaque,pokeDefensa,pokeVida):
        ...
        ImgTipo = tk.Label(frm_test,width=50,text="Top 3 los mejores Pokemon",bg="white",relief="flat").pack(fill=Y)
        ...
        for i in range(3):
            ...
            try:
                ...
                tk.Button(master=frm_test,image=rutasImg[i], relief="flat",bg="white").pack(fill=Y)
                tk.Label(master=frm_test,text=pokeNombre.iloc[i]).pack(fill=BOTH)
                print("pongo la imagen")
            except:
                tk.Label(
            ...
            barra = Progressbar(master=frm_test, orient=HORIZONTAL,
                                value=50, length=100, mode='determinate')
            barra.pack(expand=True,fill=X)
            ...
            #frm_test.grid(row=i+1, column=2, pady=10, padx=10)
            #pokeT = "PODER TOTAL "+str(pokePoder.iloc[i])+"%"
            #poderPorcent = int(pokePoder.iloc[i])*0.100
            #print(poderPorcent)
            #tk.Label(master=frm_test, text=pokeT,bg="white", fg="black",width=90).pack()
            #barra = Progressbar(master=frm_test, orient=HORIZONTAL,value=poderPorcent, length=100, mode='determinate')
            #barra.pack(expand=True,fill=X)
...
class GUI(tk.Tk):
    ...
    def __init__(self):
        ...
        def verEstadisticas(tipoPokemon):
            nombre = tipoPokemon
            ...
            print(poder.salud)
            nuevo = datosGUI(nombre,poder.poder,poder.nombre,poder.ataque,poder.defensa,poder.salud)  
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_bug,relief=FLAT,bg="white",command=lambda: verEstadisticas("Bug")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_dark,relief=FLAT,bg="white",command=lambda: verEstadisticas("Dark")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_dragon,relief=FLAT,bg="white",command=lambda: verEstadisticas("Dragon")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_Electric,relief=FLAT,bg="white",command=lambda: verEstadisticas("Electric")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_fairy,relief=FLAT,bg="white",command=lambda: verEstadisticas("Fairy")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_fighting,relief=FLAT,bg="white",command=lambda: verEstadisticas("Fighting")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_Fire,relief=FLAT,bg="white",command=lambda: verEstadisticas("Fire")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_flying,relief=FLAT,bg="white",command=lambda: verEstadisticas("Flying")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_ghost,relief=FLAT,bg="white",command=lambda: verEstadisticas("Ghost")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_grass,relief=FLAT,bg="white",command=lambda: verEstadisticas("Grass")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_ground,relief=FLAT,bg="white",command=lambda: verEstadisticas("Ground")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_ice,relief=FLAT,bg="white",command=lambda: verEstadisticas("Ice")).pack()
        ...
        Boton = tk.Button(master=frame,text=f"Cuadro",image=img_normal,relief=FLAT,bg="white",command=lambda: verEstadisticas("Normal")).pack()
        ...
        Boton = tk.Button(master=frame, text=f"Cuadro",image=img_poison,relief=FLAT,bg="white",command=lambda: verEstadisticas("Poison")).pack()
        ...
        Boton = tk.Button(master=frame, text=f"Cuadro",image=img_psychic,relief=FLAT,bg="white",command=lambda: verEstadisticas("Psychic")).pack()
        ...
        Boton = tk.Button(master=frame, text=f"Cuadro",image=img_rock,relief=FLAT,bg="white",command=lambda: verEstadisticas("Rock")).pack()
        ...
        Boton = tk.Button(master=frame, text=f"Cuadro",image=img_stell,relief=FLAT,bg="white",command=lambda: verEstadisticas("Steel")).pack()
        ...
        Boton = tk.Button(master=frame, text=f"Cuadro",image=img_water,relief=FLAT,bg="white",command=lambda: verEstadisticas("Water")).pack()
